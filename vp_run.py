...
SPEC = []
for kind, mid, short in [("a", "claude-opus-5", "opus-5"), ("o", "gpt-5.6-sol", "sol")]:
    for rep in range(1, 11): SPEC.append((kind, mid, short, "V", rep))
    for rep in range(1, 11): SPEC.append((kind, mid, short, "P", rep))
JOBS = [SPEC[i] for i in range(0, len(SPEC), 2)] + [SPEC[i] for i in range(1, len(SPEC), 2)]
